...
![array-2](./images/array-2.png "array-2")

数组 arr 有 5 个元素，每个元素占 4 个字节，从首地址 0x0046f958 开始，依次为:
![array-1](./images/array-1.png "array-1")
...
数组名与数组名取地址:
- arr 表示一个二维数组，值是数组的首地址，类型是 int[2][5]

![point_array_02.png](./images/point_array_02.png "point_array_02.png")

- arr + 0 表示一个数组指针，值是第 1 行地址，类型是 int[5] *

![point_array_03.png](./images/point_array_03.png "point_array_03.png")

- \*(arr+0) 表示一个一维数组，值是第 1 个元素的地址，类型是 int[5]

![point_array_04.png](./images/point_array_04.png "point_array_04.png")

- \*(arr+0)+0 表示一维数组里的第一个元素的地址，类型是 int *

![point_array_05.png](./images/point_array_05.png "point_array_05.png")

- \*(\*(arr+0)+0) 表示一维数组里的第一个元素的值，类型是 int

![point_array_06.png](./images/point_array_06.png "point_array_06.png")

- \*arr 表示一个一维数组，值是第 1 个元素的地址，类型是 int[5]

![point_array_03.png](./images/point_array_03.png "point_array_03.png")

- \*arr + 0 表示一维数组里的第一个元素的地址，类型是 int *

![point_array_04.png](./images/point_array_04.png "point_array_04.png")

- \*(\*arr + 0) 表示一维数组里的第一个元素的值，类型是 int

![point_array_05.png](./images/point_array_05.png "point_array_05.png")

- arr + 1 表示第 2 行地址，类型是 int[5] *

![point_array_04.png](./images/point_array_04.png "point_array_04.png")

- &arr 表示整个数组的首地址，类型是 int [2][5]

![point_array_05.png](./images/point_array_05.png "point_array_05.png")

- &arr + 0 表示整个数组的首地址，类型是 int [2][5]

![point_array_06.png](./images/point_array_06.png "point_array_06.png")

- &arr + 1 表示整个数组的首地址，类型是 int [2][5]

![point_array_07.png](./images/point_array_07.png "point_array_07.png")

第一、二行的首地址 arr[0]、arr[1]:
![array-11](./images/array-11.png "array-11")

数组 arr[2][5] 里的每个元素在内存里的存储形式:
![array-12](./images/array-12.png "array-12")

通过 **行地址 + 偏移量** 来访问数组 arr[2][5] 里的每个元素的地址:
![array-13](./images/array-13.png "array-13")

也可以通过 **行指针 + 偏移量** 来访问数组 arr[2][5] 里的每个元素的地址:
![array-18](./images/array-18.png "array-18")

通过数组下标来访问数组 arr[2][5] 里的每个元素的值:
![array-19](./images/array-19.png "array-19")

也可以通过 **行指针 + 偏移量** 来访问数组 arr[2][5] 里的每个元素的值:
![array-20](./images/array-20.png "array-20")
